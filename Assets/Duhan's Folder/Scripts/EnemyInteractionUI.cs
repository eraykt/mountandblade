...
namespace MountAndBlade
{
    public class EnemyInteractionUI : MonoBehaviour
    {
        ...
        //public EnemyHandler enemyHandler; ileride asker say�s�na g�re u�'� manip�le etmek i�in kullan�labilir.
        public GameObject player;

        private bool isInterractable = false;
        private bool canBeOpenedAgain = true;// alan�n i�indeyken s�rekli a��k kalmamas� i�in.
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            Debug.Log("carpistimve playe null de�il");
